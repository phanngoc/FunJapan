...
@else
    <div>
        <p>
            <strong>
                <a href="{{ route('login') }}">{{ trans('web/post_photo.label.login') }}</a>
                {{ trans('web/post_photo.label.or') }}
                <a href="{{ route('register') }}">{{ trans('web/post_photo.label.create_account') }}</a>
                {{ trans('web/post_photo.label.to_post') }}
            </strong>
        </p>
    </div>
@endif
