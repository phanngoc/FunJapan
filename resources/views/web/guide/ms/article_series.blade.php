...
@section('content_child')
    <div>
        ...
        <strong><span style="font-size: 24px; color: #ff0000;">{{ trans('web/guide.article_series.title_campaign') }}</span></strong><br>
        <a href="#">
            <img
                height="90"
        ...
        <strong>
            <span style="font-size: 24px; color: #ffc000;"><br>{{ trans('web/guide.article_series.title_how_to') }}</span>
        </strong><br>
        <a href="#">
            <img
                height="90"
        ...
        <br><br><br>
        <strong>
            <span style="font-size: 24px; color: #f79646;">
        ...
        <br><br><br><br>
        <strong>
            <span style="font-size: 24px; color: #00b050;"><br>{{ trans('web/guide.article_series.title_word') }}</span>
        </strong><br>
        <a href="#">
            <img
                height="90"
        ...
        <strong>
            <span style="font-size: 24px; color: #ffc000;">
        ...
        <strong>
            <span style="font-size: 24px; color: #00b050;"><br><br>
    ...
    <strong>
        <span style="font-size: 24px; color: #548dd4;"><br>
