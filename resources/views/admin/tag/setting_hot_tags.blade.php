...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title"><h2>{{ trans('admin/tag.setting_hot_tags') }}</h2></div>
                <div class="ibox-content">
                    <div class="row">
                        {{ Form::open([
                                'action' => 'Admin\TagsController@settingHotTags',
                                'method' => 'GET',
                                'class' => 'tags-list',
                            ])
                        }}
                    ...
                    <div class="table-responsive">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="tag-table" data-url="{{action('Admin\TagsController@getListTags', ['locale_id' => $localeId])}}" data-setting-url="{{action('Admin\TagsController@updateHotTag')}}">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">{{ trans('admin/tag.setting_hot_tags') }}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
