...
return [
    ...
    'faq' => [
        ...
        'login_answer' => 'There is no difference in membe常見問題rship benefits.  By logging in with Facebook, you do not need to create a new user ID and password.',
    ...
    'inquiry' => [
        ...
        'japan_company_des1' => '当社へのお問い合わせ・ご意見は、<a href="mailto:sales@fj-com.co.jp">こちら</a>より承っております。',
        ...
        'english_follow_des5' => 'We are very glad to accepts your inquiries or opinions&nbsp;<a href="mailto:sales@fj-com.co.jp">here</a><br>',
    ...
    'article_series' => [
        'title' => '- Series -',
        'summary_1' => 'Kami mempunyai beberapa macam artikel mengenai Jepang! Jenis artikel apa yang kamu suka?',
        'summary_2' => 'Kami akan memposting artikelnya setiap hari.',
        'summary_3' => 'Kami akan senang jika kamu memberi feedback atau request.',
        'summary_4' => 'Jangan lupa untuk menyimaknya ya!',
        'title_campaign' => 'Campaign',
        'des_campaign' => 'Menangkan hadiah menarik di Fun!Japan campaigns!',
        'title_how_to' => 'How to ',
        'des_how_to' => 'Simaklah beberapa tips canggih yang berhubungan dengan Jepang.',
        'title_photo' => 'Fun! Japan Photos ',
        'des_photo' => 'Kamu punya photo dan photo selfie yang berhubungan dengan Jepang? Posting di sini dan bagikan pengalamanmu! ',
        'title_chat' => 'Chat Room',
        'des_chat' => 'Bergabunglah dalam percakapannya dan bagikan ketertarikanmu akan Jepang dengan sesama anggota Japan-lovers dan staf Fun! Japan.',
        'title_reporte' => 'Fun! Japan Reporter',
        'des_reporte' => 'Baca artikel yang ditulis oleh member Fun! Japan!',
        'title_word' => 'Fun! Japan Words',
        'des_word' => 'Kamu pasti akan tertarik series ini jika kamu menyenangi Bahasa Jepang!',
        'title_talk' => 'Fun! Japan Talk',
        'des_talk' => 'Kamu dapat berinteraksi dengan sesama anggota Fun! Japan dengan chatting dalam berbagai macam topik  setiap minggu!
        Kami menunggu komen kamu yang menarik di quick survey - style quiz!
        Tentu saja kami akan berbagi hasil survey di page kami.',
        'title_member' => 'Members only',
        'des_member' => 'Kami berterima kasih pada pihak yang telah mendaftar di program membership kami, kami akan memposting artikel spesialnya!
        Jika kamu ingin tahu, mau kah kamu mendaftar di program kami? Tentu saja GRATIS. ',
        'title_test' => 'Personality Test',
        'des_test' => 'Pelajari jiwa terdalammu hanya dalam dua menit.',
        'title_rewards' => 'Fun! Japan Rewards',
        'des_rewards' => 'Jawab pertanyaan menarik pada survey mengenai Jepang! Dari jawabanmu Fun! Japan akan membuat beberapa artikel dan campaigns yang baru!',
    ],
];
