$(function () {
    ...
    if (lastListElementStartPosition + lastListElement.width() > containerWidth) {
        ...
        if (activeListElement[0]) {
            ...
            var marginLeft = 3;
            slideElement.css({ 'transform': 'translateX(' + (-activeStartPosition + marginLeft) + 'px)' });
            ...
            if ((lastListElement.position().left + lastListElement.width()) < containerWidth) {
                ...
                slideElement.css({ 'transform': 'translateX(' + translate + 'px)' });
            }
        }
        ...
        slideElement.bind({
            ...
            'touchstart': function (e) {
                ...
                $targetElement.css({ 'transition-duration': '0ms' });
            ...
            'touchmove': function (e) {
                ...
                $targetElement.css({ 'transform': 'translateX(' + distance + 'px)' });
            },
            ...
            'touchend': function (e) {
                ...
                if ($targetElement.position().left > 0) {
                    $targetElement.css({ 'transition-duration': '600ms' });
                    $targetElement.css({ 'transform': 'translateX(0px)' });
                }
